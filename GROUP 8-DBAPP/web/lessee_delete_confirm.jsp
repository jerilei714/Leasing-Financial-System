...
<head>
    ...
    <title>Lessee Delete Confirmation</title>
    <style>
        body {
...
<body>
    ...
    <div class="message-container">
        ...
        <% if (lesseeInfo != null) { %>
            ...
            <form action="lessee_delete_processing.jsp" method="POST">
                <label for="lessee_id">Confirm deleting this lessee?</label> <br>
                <button type="submit">Confirm</button>     
            </form>
            <a href="lessee_info.html">Cancel</a>
