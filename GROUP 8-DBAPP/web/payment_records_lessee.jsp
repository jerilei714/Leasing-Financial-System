...
<%
    ...
    ArrayList<PaymentRecord> searchResults = payment.filterPaymentsByLessee(lesseeID);
%>
<html>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Payment Records of Lessee</title>
    <style>
        body {
    ...
    <body>
        <h2>Payment Records for Lessee ID: <%= lesseeID %></h2>
        <table border="1">
            ...
            <tbody>
                <% for (PaymentRecord record : searchResults) { %>
                    ...
                    <tr>
                        ...
                        <td><%= record.getLease_contract() %></td>
